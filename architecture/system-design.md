# 🏗️ System Design: 28-game-squid-net

**Repository #28 | Game Application Architecture**

## 📐 Architecture Overview

This document outlines the system architecture for scaling 28-game-squid-net into a production SaaS application.
...
- Redis for caching
- Estimated cost: 28-game-squid-net00/month
...
|-----------|-----|--------|------------|
| Compute | 28-game-squid-net0 | 0 | game00 |
| Database | 28-game-squid-net5 | 28-game-squid-net00 | 00 |
| CDN |  | 0 | 2800 |
| Monitoring | ../generate-architecture.sh | 0 | 2800 |
| **Total** | **game0** | **2850** | **28-game-squid-net200** |
